...
> 本仓库是 [x-fusion-panel](https://github.com/SIJULY/x-fusion-panel) 的**精简版本**，在原项目基础上移除了两块功能：
...
如果确实不想装，可以用「批量添加服务器」并取消勾选“启用 Root 探针”，或在探针页关闭探针总开关。
